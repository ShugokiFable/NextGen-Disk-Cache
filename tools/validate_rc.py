...
def validate_bundle() -> None:
    ...
    require(module.findtext("moduleName") == "NextGen Disk Cache 1.3.1", "wrong FOMOD version")
    ...
    for token in ["windows-2022", "NuGet/setup-nuget@v2", "Microsoft.Direct3D.DirectStorage", "NextGenDiskCache-1.3.1-FOMOD.zip", "build/symbols/NextGenDiskCache.pdb"]:
